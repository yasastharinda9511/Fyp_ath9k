...
int get_hw_qnum(u16 queue, int *hwq_map)
{
	...
	printk(KERN_ALERT "file drv_htc_txrx.c  function: get_hw_qnum ");
	switch (queue) {
	case 0:
...
{
	printk(KERN_ALERT "file drv_htc_txrx.c  function: ath9k_htc_check_stop_queue ");
...
void ath9k_htc_check_wake_queues(struct ath9k_htc_priv *priv)
{
	...
	printk(KERN_ALERT "file drv_htc_txrx.c  function: ath9k_htc_check_wake_queues ");
	spin_lock_bh(&priv->tx.tx_lock);
	if ((priv->tx.queued_cnt < ATH9K_HTC_TX_THRESHOLD) &&
	    (priv->tx.flags & ATH9K_HTC_OP_TX_QUEUES_STOP)) {
		priv->tx.flags &= ~ATH9K_HTC_OP_TX_QUEUES_STOP;
...
{
	int slot;
	printk(KERN_ALERT "file drv_htc_txrx.c  function: ath9k_htc_tx_get_slots");
	spin_lock_bh(&priv->tx.tx_lock);
...
{
	printk(KERN_ALERT "file drv_htc_txrx.c function: ath9k_htc_clear_slots ");
	spin_lock_bh(&priv->tx.tx_lock);
						...
						u16 qnum)
{
	...
	printk(KERN_ALERT "file drv_htc_txrx.c  function: get_htc_epid");
	switch (qnum) {
	case 0:
...
get_htc_epid_queue(struct ath9k_htc_priv *priv, u8 epid)
{
	...
	printk(KERN_ALERT "file drv_htc_txrx.c  function: get_htc_epid_queue");
				   ...
				   struct sk_buff *skb)
{
	...
	printk(KERN_ALERT "file drv_htc_txrx.c  function: strip_drv_header");
	struct ath_common *common = ath9k_hw_common(priv->ah);
...
{
	printk(KERN_ALERT "file drv_htc_txrx.c  function: ath_htc_txq_update");
			      ...
			      u8 sta_idx, u8 vif_idx, u8 slot)
{
	...
	printk(KERN_ALERT "file drv_htc_txrx.c  function: ath9k_htc_tx_mgmt");
	...
	printk(KERN_ALERT "mgmt q number is %d", qnum);

	//printk(KERN_ALERT "BEGINING OF TX_MGMT START");
        //printk(KERN_ALERT "Socket Data is %u" ,skb->head);
       // printk(KERN_ALERT "Socket Data is %u" ,skb->data);
        //printk(KERN_ALERT "Socket Data is %u" ,skb->tail);
        //printk(KERN_ALERT "Socket Data is %u" ,skb->end);
	...
	//printk(KERN_ALERT "END  OF TX_MGMT START");
        //printk(KERN_ALERT "Socket Data is %u" ,skb->head);
        //printk(KERN_ALERT "Socket Data is %u" ,skb->data);
        //printk(KERN_ALERT "Socket Data is %u" ,skb->tail);
        //printk(KERN_ALERT "Socket Data is %u" ,skb->end);
...
static void ath9k_htc_tx_data(struct ath9k_htc_priv *priv,
			      ...
			      bool is_cab)
{
	printk(KERN_ALERT "file drv_htc_txrx.c  function: get_htc_tx_data ");
	struct ieee80211_tx_info *tx_info = IEEE80211_SKB_CB(skb);
	struct ieee80211_hdr *hdr;
	struct ath9k_htc_tx_ctl *tx_ctl;
	...
	if (ieee80211_is_data_qos(hdr->frame_control)) {
		...
		printk(KERN_ALERT "Data Frame TIDO is : %d",tx_hdr.tidno);
	}
	...
	if (!(flags & ATH9K_HTC_TX_RTSCTS) &&
		...
		printk(KERN_ALERT "CTS ON");
	}
	printk(KERN_ALERT "flag is : %x",flags);
	...
	printk(KERN_ALERT "MYYYYY QNUM ISSSS : %d", qnum);
		       ...
		       u8 slot, bool is_cab)
{
	...
	printk(KERN_ALERT "file drv_htc_txrx.c  function: ath9k_htc_tx_start ");
	struct ieee80211_hdr *hdr;
	struct ieee80211_tx_info *tx_info = IEEE80211_SKB_CB(skb);
	...
	//printk(KERN_ALERT "BEGINING OF TX START");
        //printk(KERN_ALERT "Socket Data is %u" ,skb->head);
        //printk(KERN_ALERT "Socket Data is %u" ,skb->data);
        //printk(KERN_ALERT "Socket Data is %u" ,skb->tail);
        //printk(KERN_ALERT "Socket Data is %u" ,skb->end);
	...
	//printk(KERN_ALERT "@END OF TX START");
        //printk(KERN_ALERT "Socket Data is %u" ,skb->head);
        //printk(KERN_ALERT "Socket Data is %u" ,skb->data);
        //printk(KERN_ALERT "Socket Data is %u" ,skb->tail);
        //printk(KERN_ALERT "Socket Data is %u" ,skb->end);
...
{
	printk(KERN_ALERT "file drv_htc_txrx.c  function: __ath9k_htc_check_tx_aggr");
	bool ret = false;
				    ...
				    struct sk_buff *skb)
{
	...
	printk(KERN_ALERT "file drv_htc_txrx.c  function: ath9k_htc_check_tx_aggr");
	struct ieee80211_sta *sta;
	struct ieee80211_hdr *hdr;
	__le16 fc;
...
{
	printk(KERN_ALERT "file drv_htc_txrx.c  function: ath9k_htc_tx_process");
	struct ieee80211_vif *vif;
	struct ath9k_htc_tx_ctl *tx_ctl;
	...
	//printk(KERN_ALERT "INSIDE TX STATUS");
	 ...
	 * the target.
	 */
	printk(KERN_ALERT "FAILED TXOK - %d vif= %d txs= %d",txok,vif,txs);
	if (!txok || !vif || !txs){
		printk(KERN_ALERT "FAILED TXOK - %d vif= %d txs= %d",txok,vif,txs);
		goto send_mac80211;
	}
...
{
	printk(KERN_ALERT "file drv_htc_txrx.c  function: ath9k_htc_tx_drainq");
	struct sk_buff *skb;
...
{
	printk(KERN_ALERT "file drv_htc_txrx.c  function: ath9k_htc_tx_drain");
...
void ath9k_tx_failed_tasklet(unsigned long data)
{
	...
	printk(KERN_ALERT "file drv_htc_txrx.c  function: ath9k_tx_failed_tasklet ");
				...
				u8 cookie, u8 epid)
{
	...
	printk(KERN_ALERT "file drv_htc_txrx.c  function: check_cookie");
	u8 fcookie = 0;
					       ...
					       struct __wmi_event_txstatus *txs)
{
	...
	printk(KERN_ALERT "file drv_htc_txrx.c  function: ath9k_htc_get_packet");
	struct ath_common *common = ath9k_hw_common(priv->ah);
...
void ath9k_htc_txstatus(struct ath9k_htc_priv *priv, void *wmi_event)
{
	...
	printk(KERN_ALERT "file drv_htc_txrx.c  function: ath9k_htc_tx_status");
		    ...
		    enum htc_endpoint_id ep_id, bool txok)
{
	...
	printk(KERN_ALERT "file drv_htc_txrx.c  function: ath9k_htc_txep");
...
static inline bool check_packet(struct ath9k_htc_priv *priv, struct sk_buff *skb)
{
	...
	printk(KERN_ALERT "file drv_htc_txrx.c  function: ath9k_htc_check_packet");
	struct ath_common *common = ath9k_hw_common(priv->ah);
	struct ath9k_htc_tx_ctl *tx_ctl;
...
static void ath9k_htc_tx_cleanup_queue(struct ath9k_htc_priv *priv,
				       struct sk_buff_head *epid_queue)
{
	//printk(KERN_ALERT "file drv_htc_txrx.c  function: ath9k_htc_tx_cleanup_queue");
	bool process = false;
	unsigned long flags;
	struct sk_buff *skb, *tmp;
	struct sk_buff_head queue;
...
void ath9k_htc_tx_cleanup_timer(struct timer_list *t)
{
	...
	printk(KERN_ALERT "file drv_htc_txrx.c  function: ath9k_htc_cleanup_timer");
...
int ath9k_tx_init(struct ath9k_htc_priv *priv)
{
	...
	printk(KERN_ALERT "file drv_htc_txrx.c  function: ath9k_tx_init");
...
bool ath9k_htc_txq_setup(struct ath9k_htc_priv *priv, int subtype)
{
	...
	printk(KERN_ALERT "file drv_htc_txrx.c  function: ath9k_htc_txq_setup");
	struct ath_hw *ah = priv->ah;
...
{
	printk(KERN_ALERT "file drv_htc_txrx.c  function: ath9k_htc_cabq_setup");
	struct ath9k_tx_queue_info qi;
...
#define	RX_FILTER_PRESERVE (ATH9K_RX_FILTER_PHYERR | ATH9K_RX_FILTER_PHYRADAR)
	printk(KERN_ALERT "file drv_htc_txrx.c  function: ath9k_htc_calcrxfilter");
	struct ath_hw *ah = priv->ah;
	u32 rfilt;
